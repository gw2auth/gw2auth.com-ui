...
export function PrivacyPolicy() {
  ...
  return (
    <ContentLayout header={<Header variant={'h1'} description={i18n.pages.privacyPolicy.lastUpdated(formatDate(LAST_UPDATED))}>Privacy Policy</Header>} headerVariant={'high-contrast'}>
      ...
      <Container variant={'stacked'} header={<Header variant={'h2'}>Cookies & Local storage</Header>}>
        <ColumnLayout columns={1}>
          ...
          <ExpandableSection headerText={'Cookies'}>
            <ColumnLayout columns={1}>
              <StorageDetail name={'BEARER'}>
                <CookieDetail type={'Strictly necessary'} expiration={'30 Days'} details={'The BEARER cookie is used to recognize you across multiple requests. It is only created if it is technically required to do so, for example when logging in. This cookie is valid for 30 days upon creation.'} />
              </StorageDetail>

              <StorageDetail name={'REDIRECT_URI'}>
                <CookieDetail type={'Strictly necessary'} expiration={'Session'} details={'The REDIRECT_URI cookie keeps information of a page you attempted to access while not being logged in. This cookie is required to send you back to the page you initially requested once you successfully logged in.'} />
              </StorageDetail>
              ...
              <StorageDetail name={<Box variant={'h4'}>cookieconsent_status <Box variant={'small'}>(historical)</Box></Box>}>
                <CookieDetail type={'Strictly necessary'} expiration={'2 Years'} details={'Used to remember your decision of the Cookie-Consent Banner on this device. This cookie is no longer used and will no longer be created.'} />
              </StorageDetail>

              <StorageDetail name={<Box variant={'h4'}>JSESSIONID <Box variant={'small'}>(historical)</Box></Box>}>
                <CookieDetail type={'Strictly necessary'} expiration={'2 Years'} details={'This cookie is no longer used and will no longer be created.'} />
              </StorageDetail>
            </ColumnLayout>
          </ExpandableSection>
          ...
          <ExpandableSection headerText={'Local storage'}>
            <ColumnLayout columns={1}>
              <StorageDetail name={'GW2AUTH:CONSENT'}>
              ...
              <StorageDetail name={'GW2AUTH:PREFERENCES'}>
              ...
              <StorageDetail name={'GW2AUTH:PREVIOUS_ISSUER'}>
                <LocalStorageDetail type={'Strictly necessary'} details={'Used to remember the login provider you used the login before.'} />
              </StorageDetail>

              <StorageDetail name={<Box variant={'h4'}>GW2AUTH:PREFERRED_COLOR_SCHEME <Box variant={'small'}>(historical)</Box></Box>}>
                <LocalStorageDetail type={'Functional'} details={'Used to remember your appearance choice on this device. This key is no longer used and will no longer be created.'} />
              </StorageDetail>
            </ColumnLayout>
          </ExpandableSection>
        </ColumnLayout>
      ...
      <Container variant={'stacked'} header={<Header variant={'h2'}>How we use collected information</Header>}>
        <Box variant={'p'}>GW2Auth may collect and use personal information for the following purposes:</Box>
        <TextContent>
          <ul>
            <li>
      ...
      <Container variant={'stacked'} header={<Header variant={'h2'}>Children's information</Header>}>
        ...
        <Box variant={'p'}>
          GW2Auth does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records.
        </Box>
      </Container>
      ...
      <Container variant={'stacked'} header={<Header variant={'h2'}>Changes to this privacy policy</Header>}>
        <Box variant={'p'}>
          GW2Auth has the discretion to update this privacy policy at any time.
